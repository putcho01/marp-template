...
if [ "$html_option_set" = true ]; then
  npx marp "$1" -o "output/$file_name/$title.pptx" --allow-local-files --html --theme "style/css/$theme.css"
else
  npx marp "$1" -o "output/$file_name/$title.pptx" --allow-local-files --theme "style/css/$theme.css"
fi
